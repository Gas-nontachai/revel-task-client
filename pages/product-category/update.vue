...
const { getProductCategoryByID, updateProductCategoryBy } = useProductCategory();
...
async function onSubmit() {
  ...
  try {
    ...
    await updateProductCategoryBy(product_category.value);
...
function validateForm(): boolean {
  if (!(product_category.value.product_category_id && product_category.value.product_category_name)) {
