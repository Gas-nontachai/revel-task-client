...
const { getBranchByID, updateBranchBy, } = useBranch();
      ...
      <v-card-text class="py-4">
        <v-row>
          <v-col cols="12" md="6" lg="3">
            ...
            <v-text-field v-model="branch.branch_id" density="compact" disabled variant="outlined"></v-text-field>
          </v-col>
        </v-row>
        <v-row>
          <v-col cols="12" md="6" lg="3">
