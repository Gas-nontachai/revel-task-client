...
const { generateProductID, getProductBy, insertProduct, } = useProduct();
...
onMounted(async () => {
  try {
    product.value.product_id = await generateProductID()
...
async function onSubmit() {
  ...
  try {
    ...
    await insertProduct(product.value)
        ...
        <div style="overflow-x: auto">
          <table class="table-detail" style="min-width: 800px" aria-describedby="detail">
            ...
            <tbody>
              <tr>
                <td>
                  <v-text-field v-model="product.product_unit_name1" density="compact" variant="outlined"
                    hide-details></v-text-field>
                </td>
                <td>
                  <v-text-field v-model="product.product_unit_qty1" class="text-right" density="compact"
                    variant="outlined" hide-details @keypress="onlyNumeric"></v-text-field>
                </td>
                <td>
              ...
              <tr>
                <td>
                  <v-text-field v-model="product.product_unit_name2" density="compact" variant="outlined"
                    hide-details></v-text-field>
                </td>
                <td>
              ...
              <tr>
                <td>
                  <v-text-field v-model="product.product_unit_name3" density="compact" variant="outlined"
                    hide-details></v-text-field>
                </td>
                <td>
              ...
              <tr>
                <td>
                  <v-text-field v-model="product.product_unit_name4" density="compact" variant="outlined"
                    hide-details></v-text-field>
                </td>
                <td>
              ...
              <tr>
                <td>
                  <v-text-field v-model="product.product_unit_name5" density="compact" variant="outlined"
                    hide-details></v-text-field>
                </td>
                <td>
