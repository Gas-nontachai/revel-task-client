...
onMounted(async () => {
  try {
    supplier.value.supplier_id = await generateSupplierID()
...
async function onSubmit() {
  ...
  try {
    ...
    await insertSupplier(supplier.value);
      ...
      <v-card-text class="py-4">
        <v-row>
          <v-col cols="12" sm="6" lg="3">
            ...
            <v-text-field v-model="supplier.supplier_id" density="compact" :rules="[rules.required]"
