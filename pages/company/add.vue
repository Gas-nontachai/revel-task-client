...
const { generateCompanyID, insertCompany, } = useCompany();
...
onMounted(async () => {
  try {
    company.value.company_id = await generateCompanyID()
...
async function onSubmit() {
  ...
  try {
    ...
    await insertCompany(company.value)
          ...
          <v-col cols="12" md="8">
            <v-row>
              <v-col cols="12" md="6" lg="3">
                ...
                <v-text-field v-model="company.company_id" density="compact" :rules="[rules.required]"
